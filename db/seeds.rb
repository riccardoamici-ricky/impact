...
upcycle = Event.create!(title: "Pimp up your old clothes", description: "What if we told you that your old clothes can become amazing again? Join us in our workshop for upciclying, we provide sewing material!", address: "Leopoldplatz, Berlin", neighbourhood: "Wedding", category: "Sustainability", start_time: "10 Dec 4:00", user_id: laura[:id])
...
cleaning = Event.create!(title: "Let's clean Hasenheide!", description: "It is now time to give back to our beloved park, let's go and collect trash and bottle caps! Bring comfy shoes!", address: "Hasenheide, Berlin", neighbourhood: "Neukölln", category: "Environment", start_time: "22 Dec 8:00", user_id: laura[:id])
...
protest = Event.create!(title: "Free Melania", description: "Melania Trump, is she really Donald Trump’s prisoner? Or is she normal simple woman?", address: "Hermannplatz, Berlin", neighbourhood: "Neukölln", category: "Protest", start_time: "9 Jan 17:00", user_id: laura[:id])
